...
function shin_scripts()
{
    ...
    wp_enqueue_style('swiper-css', THEME_URL . '-child' . '/assets/libs/swiper/swiper-bundle.min.css', array(), $version, 'all');

    wp_enqueue_script('main-scripts-js', THEME_URL . '-child' . '/assets/dist/js/main.min.js', array('jquery'), $version, true);
    wp_enqueue_script('swiper-js', THEME_URL . '-child' . '/assets/libs/swiper/swiper-bundle.min.js', array('jquery'), $version, true);
}
